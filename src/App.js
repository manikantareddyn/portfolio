...
const CyberPortfolio = () => {
  ...
  const CertificationCard = ({ cert, index }) => (
    <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-6 hover:border-cyan-400 transition-colors duration-300">
          ...
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-6 text-center hover:border-cyan-400 transition-colors duration-300">
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-6">
              {projects.map((project, index) => (
                <div key={index} className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-8 hover:border-cyan-400 transition-colors duration-300">
